...
<head>
    ...
    <link rel="shortcut icon" href="src/assets/img/logo/logo-png.png" type="image/x-icon">
    ...
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
      <div class="flex lg:flex-1">
        <a href="#" class="-m-1.5 p-1.5">
          ...
          <img class="h-10 w-auto" src="src/assets/img/logo/logo-transparent-png.png" alt="">
        </a>
      </div>
